...
hugo
hugo -d ../felipefariax.github.io # This builds the public site into your public repo. !!!!! Make sure to replace with your currect public repo here

# Deploy your public site
cd ../felipefariax.github.io # Goes to your public site repo
...
cd ../site_backend #!!!!! Make sure to replace with your currect backend repo here.
git add . # Adds changes
